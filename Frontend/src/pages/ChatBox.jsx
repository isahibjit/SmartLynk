...
const ChatBox = () => {
  ...
  return (
    <div className="flex flex-col w-full  min-h-screen bg-white font-sans px-8">
      {/* Header */}
      {/* Chat Title */}
      ...
      <div className="flex items-center gap-4">
        <input
          ...
          className="border border-gray-300 rounded-md py-2 px-1 text-md w-[60vw] outline-none "
        />
